...
object DashboardScreen : KScreen<DashboardScreen>() {
    ...
    val yearLabel = KTextView {
        withId(R.id.dashboard_year)
    }
    val previousMonthButton = KButton {
        withId(R.id.dashboard_month_previous)
    }

    val monthLabel = KTextView {
        withId(R.id.dashboard_month)
    }
    val nextMonthButton = KButton {
        withId(R.id.dashboard_month_next)
    }
}
