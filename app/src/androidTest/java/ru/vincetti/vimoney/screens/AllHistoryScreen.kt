...
object AllHistoryScreen : KScreen<AllHistoryScreen>() {
    ...
    val toolbarBackButton = KButton { withId(R.id.records_navigation_back_btn) }
    val filterButton = KButton { withId(R.id.records_filter_btn) }
    val fab = KButton { withId(R.id.all_history_fab) }
}
