...
object SettingsScreen : KScreen<SettingsScreen>() {
    ...
    val categoriesButton = KButton { withId(R.id.settings_categories_btn) }
    val saveJSONButton = KButton { withId(R.id.save_transactions_btn) }
    val loadJSONButton = KButton { withId(R.id.load_transactions_btn) }
}
