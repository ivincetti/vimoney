...
import static ru.vincetti.vimoney.transaction.TransactionConst.EXTRA_TRANS_ID;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TransactionsRVAdapter transactionsRVAdapter = new TransactionsRVAdapter(
                itemId -> {
                    ...
                    bundle.putInt(EXTRA_TRANS_ID, itemId);
                    Navigation.findNavController(view)
                            .navigate(R.id.action_allHistoryFragment_to_transactionMainFragment, bundle);
                }
        );
